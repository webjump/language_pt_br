...
# Version & progress
This translation is generated from the branch [Head](https://crowdin.com/project/magento-2/pt-BR#/Head) at Crowdin and based on the Magento 2.1.1 sourcefiles.
There have been  5904 strings translated of the 8412 strings in the Magento source.
...
# Contribute
To help push the '*Brazilian Portuguese (português do Brasil) Magento2 Language Pack (pt_BR)*' forward please goto [this](https://crowdin.com/project/magento-2/pt-BR) crowdin page and translate the lines.
